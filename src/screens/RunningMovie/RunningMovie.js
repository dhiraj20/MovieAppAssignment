                                    ...
                                    >
                                        {genres && (genres.map((data) => (
                                            <MenuItem key={data.genre} value={data.genre}>
                                                <Checkbox checked={personName.indexOf(data.genre) > -1}/>
                            ...
                            <div className="form-control">
                                <FormControl className={multiSelect.formControl}>
                                    ...
                                    <Select
                                        ...
                                        input={<Input/>}
                                        renderValue={(selected) => selected.map(data => `${data.first_name} ${data.last_name}`).join(", ")}
                                        MenuProps={MenuProps}
                                    >
                                        {artists && (artists.map((data) => (
                                            <MenuItem key={data.id} value={data}>
                                                <Checkbox checked={artistsList.some(artist => artist.id === data.id)}/>

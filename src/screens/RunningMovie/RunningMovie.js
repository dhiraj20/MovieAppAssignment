...
export default function RunningMovies(props) {
    ...
    async function getMovies() {
        let url = baseUrl + 'movies?page=1&limit=200';
        if (title) {
            url = url + '&title='+title;
        }
        if (selectedGenre.length > 0) {
            url = url + '&genre='+selectedGenre.join(",");
        }
        if (artistsList.length > 0) {
            url = url + '&artists='+artistsList.map(artist => artist.first_name + " " + artist.last_name).join(",");
        }
        if(start_date) {
                    ...
                    <CardContent>
                        ...
                        <form className="running-form">
                                    ...
                                    >
                                        ...
                                        genres.map((data) => (
                                            <MenuItem key={data.genre} value={data.genre}>
                                                <Checkbox
                                                    checked={selectedGenre.indexOf(data.genre) > -1}
                                                />
                            ...
                            <div className="form-control">
                                ...
                                <FormControl className={multiSelect.formControl}>
                                    <TextField id="start_date" type="date" defaultValue={start_date}
                            ...
                            <div className="form-control">
                                ...
                                <FormControl className={multiSelect.formControl}>
                                    <TextField id="end_date" type="date" defaultValue={end_date}

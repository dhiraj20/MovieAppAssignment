...
export default function Details(props) {
  ...
  return (
    <div>
      ...
      <Typography className={classes.root} onClick={backToHome}>
        &#60; Back to Home
      </Typography>
      {movie && (
        <div className="detailscontainer">
          ...
          <div className="middle">
            ...
            <Typography>
              <span className="boldtext">Genre: </span>
              {movie.genres && movie.genres.join(',')}
            </Typography>
            <Typography>
              <span className="boldtext">Duration: </span>
              {movie.duration}
            </Typography>
            <Typography>
              <span className="boldtext">Release Date: </span>
              {movie.release_date}
            </Typography>
            <Typography>
            ...
            <Typography className="mt16">
              <span className="boldtext">Trailer: </span>
            </Typography>
            {movie.trailer_url && (
              <YouTube
                videoId={getUrlId(movie.trailer_url)}
                opts={opts}
                onReady={onReady}
              />
            )}
          ...
          <div className="right">
            <Typography>
              <span className="boldtext">Rate this movie:</span>
            </Typography>
            <Rating
            ...
            />
            <Typography className="mt16">
              <span className="boldtext">Artists:</span>
            </Typography>
              ...
              {movie.artists && (
                <ImageList cols={2}>
                  {movie.artists.map((movie) => (
                    <ImageListItem
                      key={movie.profile_url}
                      className="detailsimageitem"
                    >
                      <img
